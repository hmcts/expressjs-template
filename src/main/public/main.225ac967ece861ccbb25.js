  ...
  var t = {
      ...
      743: (t, e, n) => {
        ...
        var o = n(124),
          ...
          v = n.n(f),
          b = {};
        for (const t in f) 'default' !== t && (b[t] = () => f[t]);
        n.d(e, b);
        var y = {};
        (y.styleTagTransform = m()),
          ...
          i()(v(), y);
        const g = v() && v().locals ? v().locals : void 0;
      },
      124: t => {
        'use strict';
        var e = [];
        ...
        function o(t, o) {
          for (var s = {}, r = [], a = 0; a < t.length; a++) {
            ...
            if (-1 !== h) e[h].references++, e[h].updater(p);
              ...
              var m = i(p, o);
              (o.byIndex = a), e.splice(a, 0, { identifier: d, updater: m, references: 1 });
            }
            r.push(d);
          }
          return r;
        ...
        !(function (t) {
                ...
                Object.defineProperty(Function.prototype, 'bind', {
                  value: function (t) {
                      ...
                      var y,
                        ...
                        w = function () {
                          if (this instanceof y) {
                            var e = b.apply(this, m.call(g, p.call(arguments)));
                            return o(e) === e ? e : this;
                          }
                    ...
                    return (
                      (y = Function(
                        'binder',
                        'return function (' + k.join(',') + '){ return binder.apply(this, arguments); }'
                      )(w)),
                      b.prototype && ((r.prototype = b.prototype), (y.prototype = new r()), (r.prototype = null)),
                      y
                    );
                  },
                });
                    ...
                    return function (e, o) {
                      ...
                      return (
                        ...
                        (i.add = function () {
                          ...
                          a !== s.length &&
                            ((a = s.length >>> 0),
                            'object' == typeof e[o] ? (e[o].baseVal = s.join(' ')) : (e[o] = s.join(' ')),
                            u());
                        }),
                        (i.remove = function () {
                          d.apply(i, (t = arguments));
                ...
                (function () {
                  if (!window.Element || window.HTMLElement) {
                    ...
                    o.attachEvent('onpropertychange', function (t) {
                      for (
                        var e, n = t.propertyName, s = !i.hasOwnProperty(n), a = o[n], c = i[n], l = -1;
                        (e = r[++l]);

                      )
                        1 === e.nodeType && (s || e[n] === c) && (e[n] = a);
                      i[n] = a;
                    }),
                    ...
                    n(
                      ...
                      function () {
                        ...
                        if (((r[a] = !0), !1 === e)) {
                          ...
                          c || (c = l.appendChild(document.createElement('div'))), (t = DOMTokenList.call(c, r, s));
          ...
          (o.prototype.storeState = function (t) {
            ...
            (o.prototype.getButtonPunctuationEl = function () {
              var t = document.createElement('span');
              return (
                t.classList.add('govuk-visually-hidden', 'govuk-accordion__section-heading-divider'),
                (t.innerHTML = ', '),
                t
              );
            }),
          ...
          (r.prototype.init = function () {
            ...
            (a.prototype.updateVisibleCountMessage = function () {
              var t = this.$textarea,
            ...
            (a.prototype.updateScreenReaderCountMessage = function () {
            ...
            (a.prototype.formattedUpdateMessage = function () {
              var t,
                e = this.$textarea,
                n = this.options,
            ...
            (l.prototype.getAssociatedLegendOrLabel = function (t) {
              ...
              if (e) {
                ...
                if (n.length) {
                  ...
                  if (s.height && window.innerHeight && s.top + s.height - i < window.innerHeight / 2) return o;
                }
              }
            ...
            (d.prototype.syncState = function () {
              this.mql.matches
            ...
            (p.prototype.getLinkedElement = function () {
              var t = this.getFragmentFromUrl();
              return !!t && document.getElementById(t);
            }),
            (p.prototype.focusLinkedElement = function () {
            ...
            (p.prototype.removeFocusProperties = function () {
              this.$linkedElement.removeAttribute('tabindex'),
                this.$linkedElement.classList.remove('govuk-skip-link-focused-element');
            }),
            (p.prototype.getFragmentFromUrl = function () {
            ...
            (m.prototype.setupResponsiveChecks = function () {
              (this.mql = window.matchMedia('(min-width: 40.0625em)')),
                this.mql.addListener(this.checkMode.bind(this)),
                this.checkMode();
            }),
            (m.prototype.checkMode = function () {
            ...
            (m.prototype.onHashChange = function (t) {
            ...
            (m.prototype.unsetAttributes = function (t) {
            ...
            (m.prototype.onTabClick = function (t) {
            ...
            (m.prototype.createHistoryEntry = function (t) {
              var e = this.getPanel(t),
                n = e.id;
              (e.id = ''), (this.changingHash = !0), (window.location.hash = this.getHref(t).slice(1)), (e.id = n);
            }),
            (m.prototype.onTabKeydown = function (t) {
              switch (t.keyCode) {
                case this.keys.left:
                case this.keys.up:
            ...
            (m.prototype.activateNextTab = function () {
            ...
            (m.prototype.activatePreviousTab = function () {
              var t = this.getCurrentTab(),
                e = t.parentNode.previousElementSibling;
              if (e) var n = e.querySelector('.govuk-tabs__tab');
              n && (this.hideTab(t), this.showTab(n), n.focus(), this.createHistoryEntry(n));
            }),
            (m.prototype.getPanel = function (t) {
              return this.$module.querySelector(this.getHref(t));
            }),
            (m.prototype.showPanel = function (t) {
              this.getPanel(t).classList.remove(this.jsHiddenClass);
            }),
            (m.prototype.hidePanel = function (t) {
              this.getPanel(t).classList.add(this.jsHiddenClass);
            }),
            (m.prototype.unhighlightTab = function (t) {
              t.setAttribute('aria-selected', 'false'),
                t.parentNode.classList.remove('govuk-tabs__list-item--selected'),
                t.setAttribute('tabindex', '-1');
            }),
            (m.prototype.highlightTab = function (t) {
              t.setAttribute('aria-selected', 'true'),
                t.parentNode.classList.add('govuk-tabs__list-item--selected'),
                t.setAttribute('tabindex', '0');
            }),
            (m.prototype.getCurrentTab = function () {
              return this.$module.querySelector('.govuk-tabs__list-item--selected .govuk-tabs__tab');
            }),
            (m.prototype.getHref = function (t) {
              var e = t.getAttribute('href');
              return e.slice(e.indexOf('#'), e.length);
            }),
            (t.initAll = function (t) {
              var n = void 0 !== (t = void 0 !== t ? t : {}).scope ? t.scope : document;
              e(n.querySelectorAll('[data-module="govuk-button"]'), function (t) {
                new s(t).init();
              }),
                e(n.querySelectorAll('[data-module="govuk-accordion"]'), function (t) {
                  new o(t).init();
                }),
                e(n.querySelectorAll('[data-module="govuk-details"]'), function (t) {
                  new r(t).init();
                }),
                e(n.querySelectorAll('[data-module="govuk-character-count"]'), function (t) {
                  new a(t).init();
                }),
                ...
                e(n.querySelectorAll('[data-module="govuk-notification-banner"]'), function (t) {
                  new u(t).init();
                }),
                e(n.querySelectorAll('[data-module="govuk-radios"]'), function (t) {
                  new h(t).init();
                }),
                new p(n.querySelector('[data-module="govuk-skip-link"]')).init(),
                e(n.querySelectorAll('[data-module="govuk-tabs"]'), function (t) {
                  new m(t).init();
                });
            }),
            (t.Accordion = o),
